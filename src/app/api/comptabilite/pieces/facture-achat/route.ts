...
import { enregistrerFactureAchat } from "@/lib/services/comptabilite/pieces";
import { writeAudit, clientIp } from "@/lib/audit";

/**
 * Facture d'achat reçue par le contribuable : l'écriture est générée et enregistrée
 * au journal des achats. Un brouillon, sauf si `valider` est demandé — la
